...
import com.kongzue.find.BuildConfig;
...
/**
 * Created by chao on 2016/3/9.
 */
public class ApcpActivity  extends AppCompatActivity {
    ...
    public void toast(final Object obj) {
        try {
            runOnMain(new Runnable() {
                ...
                public void run() {
                    if (toast == null)
                        toast = Toast.makeText(ApcpActivity.this, NULL,Toast.LENGTH_SHORT);
